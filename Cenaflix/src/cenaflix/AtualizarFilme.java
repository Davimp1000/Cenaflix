...
public class AtualizarFilme extends javax.swing.JFrame {
   ...
   FilmeDao dao =  new FilmeDao();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Digite o id do filme que deseja atualizar:");
    ...
    private void btnContinuarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnContinuarActionPerformed
        ...
        try
        {
      filme.setIdAt(Integer.parseInt(txtId.getText()));
      ...
      dao.desconectar();
        ...
        {
            JOptionPane.showMessageDialog(null,"Você precisa inserir valores numéricos inteiros");
        }
